...
\begin{document}
    ...
    Sự mô tả môi trường liên tục là tốt trong gần như mọi trường hợp, nhưng những sự không liên tục vẫn có thể diễn ra ở mức độ trung mô, ta đang đề cập đến trường hợp các \bi{sóng xung kích} đối dòng khí đi qua cánh của  các máy bay trên âm hoặc \bi{sự xâm thực} đối với các chong chóng tàu thủy khi chúng xoay quá nhanh. Ta cũng sẽ tính đến các hiện tượng này trong sự mô tả môi trường liên tục và bây giờ ta sẽ mở rộng các khảo sát ra các đại lượng có sự liên tục từng khúc.
\end{document}